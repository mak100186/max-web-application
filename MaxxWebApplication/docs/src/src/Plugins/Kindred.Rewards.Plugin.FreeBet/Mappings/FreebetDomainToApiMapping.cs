...
public class FreebetDomainToApiMapping : Profile
{
    public FreebetDomainToApiMapping()
    {
        CreateMap<RewardDomainModel, FreeBetRewardResponse>(MemberList.None)
            ...
            .AfterMap(
                (s, d) =>
                {
                    d.RewardParameters = (FreeBetParametersApiModel)Extensions.Extensions.MapFromRewardTermsToRewardParameters(s.Terms, s.Type);
                });
    }
}
