...
public class UniBoostApiToDomainMapping : Profile
{
    public UniBoostApiToDomainMapping()
    {
        CreateMap<UniBoostRewardRequest, RewardDomainModel>(MemberList.None)
            ...
            .ForMember(d => d.Type, opt => opt.MapFrom(s => RewardType.Uniboost))
            ...
            .AfterMap(
                (request, model) =>
                {
                    model.Terms.RewardParameters = Extensions.Extensions.MapFromRewardParametersToDictionary(request.RewardParameters, RewardType.Uniboost.ToString());
                    model.Terms.Restrictions.Reload =
                        Extensions.Extensions.MapFromRewardParametersToRewardReload(request.RewardParameters, RewardType.Uniboost.ToString());
