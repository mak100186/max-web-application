...
namespace Kindred.Rewards.Plugin.ProfitBoost.Services;

public interface IProfitBoostService
{
...
public class ProfitBoostService : IProfitBoostService
{
    private readonly RewardsDbContext _context;
    private readonly IMapper _mapper;
    private readonly ILogger<ProfitBoostService> _logger;
    private readonly IKafkaProducerManager _producer;

    public ProfitBoostService(
        RewardsDbContext context,
        IMapper mapper,
        ILogger<ProfitBoostService> logger,
    ...
    protected static readonly IReadOnlyCollection<BetTypes> AllowedBetTypes = new List<BetTypes>
    {
        BetTypes.SingleLeg,
        BetTypes.StandardMultiLeg,
    };

    public static readonly IReadOnlyCollection<string> AllowedFormulae = FormulaExtensions.GetFormulaeForBetTypes(AllowedBetTypes);
