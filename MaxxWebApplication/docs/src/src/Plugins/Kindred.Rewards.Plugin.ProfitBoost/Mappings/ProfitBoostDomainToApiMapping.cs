...
namespace Kindred.Rewards.Plugin.ProfitBoost.Mappings;

public class ProfitBoostDomainToApiMapping : Profile
{
    public ProfitBoostDomainToApiMapping()
    {
        CreateMap<RewardDomainModel, ProfitBoostRewardResponse>(MemberList.None)
            ...
            .AfterMap(
                (s, d) =>
                {
                    d.RewardParameters = (ProfitBoostParametersApiModel)Extensions.Extensions.MapFromRewardTermsToRewardParameters(s.Terms);
                });
    }
}
