...
public class ProfitBoostApiToDomainMapping : Profile
{
    public ProfitBoostApiToDomainMapping()
    {
        CreateMap<ProfitBoostRewardRequest, RewardDomainModel>(MemberList.None)
            ...
            .ForMember(d => d.Type, opt => opt.MapFrom(s => RewardType.Profitboost))
            ...
            .AfterMap(
                (request, model) =>
                {
                    model.Terms.RewardParameters = Extensions.Extensions.MapFromRewardParametersToDictionary(request.RewardParameters, RewardType.Profitboost.ToString());
                    model.Terms.Restrictions.Reload =
                        Extensions.Extensions.MapFromRewardParametersToRewardReload(request.RewardParameters, RewardType.Profitboost.ToString());
