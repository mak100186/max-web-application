...
namespace Kindred.Rewards.Plugin.ProfitBoost.Extensions;
...
public static class Extensions
{
    ...
    where TDest : RewardDomainModel
    {
        return m
            ...
            .ForMember(d => d.Terms, o => o.MapFrom((s, _) => JsonConvert.DeserializeObject<RewardTerms>(s.TermsJson)))
            .AfterMap(
                (src, dest) =>
                {
    ...
    where TDest : Reward
    {
        return m
            ...
            .ForMember(d => d.StartDateTime, o => o.MapFrom((s, _) => s.Terms.Restrictions.StartDateTime.ApplyUtc()))
            .ForMember(d => d.ExpiryDateTime, o => o.MapFrom((s, _) => s.Terms.Restrictions.ExpiryDateTime.ApplyUtc()))

            .ForMember(d => d.ContestStatus, o => o.MapFrom((s, _) => s.Terms.Restrictions.AllowedContestStatuses))
            ...
            .ForMember(d => d.TermsJson, o => o.MapFrom((s, _) => JsonConvert.SerializeObject(s.Terms)))
            .ForMember(d => d.CountryCode, o => o.MapFrom(s => s.CountryCode))
            .ForMember(d => d.Jurisdiction, o => o.MapFrom(s => s.Jurisdiction))
            .ForMember(d => d.State, o => o.MapFrom(s => s.State))
            .ForMember(d => d.Brand, o => o.MapFrom(s => s.Brand))
    ...
    public static RewardParameterApiModelBase MapFromRewardTermsToRewardParameters(RewardTerms terms)
     => new ProfitBoostParametersApiModel
     {
    ...
    public static RewardReloadConfig MapFromRewardParametersToRewardReload(RewardParameterApiModelBase rewardParameterApiModel, string rewardType)
        => RewardParameterMappingHelper.MapFromRewardParametersToRewardReload(rewardParameterApiModel, rewardType);

    public static Dictionary<string, string> MapFromRewardParametersToDictionary(RewardParameterApiModelBase rewardParameterApiModel, string rewardType)
        => RewardParameterMappingHelper.MapFromRewardParametersToDictionary(rewardParameterApiModel, rewardType);

    private static decimal? GetOptionalRewardParameter(IDictionary<string, string> rewardParameters, string key)
      => rewardParameters.TryGetValue(key, out var result) && decimal.TryParse(result, out _)
