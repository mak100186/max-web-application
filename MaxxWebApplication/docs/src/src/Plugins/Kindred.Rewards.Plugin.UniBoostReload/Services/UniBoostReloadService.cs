...
public interface IUniBoostReloadService
{
...
public class UniBoostReloadService : IUniBoostReloadService
{
    private readonly RewardsDbContext _context;
    private readonly IMapper _mapper;
    private readonly ILogger<UniBoostReloadService> _logger;
    private readonly IKafkaProducerManager _producer;

    public Dictionary<FeatureType, IFeature> Features { get; }

    public UniBoostReloadService(RewardsDbContext context,
        IMapper mapper,
        ILogger<UniBoostReloadService> logger,
        IKafkaProducerManager producer)
    {
        ...
        Features = new()
        {
            {FeatureType.Reload, new ReloadFeature()}
        };
