...
namespace Kindred.Rewards.Infrastructure.Data.Migrations
{
    ...
    [Migration("20230705051936_AddCreatedByUpdatedByFields")]
    partial class AddCreatedByUpdatedByFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kindred.Rewards.Infrastructure.Data.DataModels.AuditReward", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Kindred.Rewards.Infrastructure.Data.DataModels.CombinationRewardPayoff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Kindred.Rewards.Infrastructure.Data.DataModels.CustomerReward", b =>
                {
            ...
            modelBuilder.Entity("Kindred.Rewards.Infrastructure.Data.DataModels.Reward", b =>
                {
            ...
            modelBuilder.Entity("Kindred.Rewards.Infrastructure.Data.DataModels.RewardClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Kindred.Rewards.Infrastructure.Data.DataModels.RewardTag", b =>
                {
                    b.Property<string>("RewardId")
                        .HasColumnType("character varying(128)")
            ...
            modelBuilder.Entity("Kindred.Rewards.Infrastructure.Data.DataModels.RewardTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Kindred.Rewards.Infrastructure.Data.DataModels.RewardTemplateCustomer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Kindred.Rewards.Infrastructure.Data.DataModels.RewardTemplateReward", b =>
                {
            ...
            modelBuilder.Entity("Kindred.Rewards.Infrastructure.Data.DataModels.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(128)
            ...
            modelBuilder.Entity("Kindred.Rewards.Infrastructure.Data.DataModels.AuditReward", b =>
                {
                    b.HasOne("Kindred.Rewards.Infrastructure.Data.DataModels.Reward", null)
                        .WithMany("Audits")
            ...
            modelBuilder.Entity("Kindred.Rewards.Infrastructure.Data.DataModels.CombinationRewardPayoff", b =>
                {
                    b.HasOne("Kindred.Rewards.Infrastructure.Data.DataModels.RewardClaim", "RewardClaim")
            ...
            modelBuilder.Entity("Kindred.Rewards.Infrastructure.Data.DataModels.CustomerReward", b =>
                {
                    b.HasOne("Kindred.Rewards.Infrastructure.Data.DataModels.Reward", "Reward")
            ...
            modelBuilder.Entity("Kindred.Rewards.Infrastructure.Data.DataModels.RewardTag", b =>
                {
                    ...
                    b.HasOne("Kindred.Rewards.Infrastructure.Data.DataModels.Tag", "Tag")
                        .WithMany("RewardTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Kindred.Rewards.Infrastructure.Data.DataModels.RewardTemplateReward", b =>
                {
                    ...
                    b.HasOne("Kindred.Rewards.Infrastructure.Data.DataModels.RewardTemplate", "RewardTemplate")
                        .WithMany("RewardTemplateReward")
