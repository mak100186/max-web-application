            ...
            modelBuilder.Entity("Kindred.Rewards.Rewards.Repositories.DataModels.RewardClaim", b =>
                {
                    ...
                    b.Property<string>("BetRef")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("CouponRef")
                        .IsRequired()
                        .HasMaxLength(255)
                        .IsUnicode(false)
                    ...
                    b.HasIndex("RewardKey", "CustomerId", "IntervalId", "UsageId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Kindred.Rewards.Rewards.Repositories.DataModels.RewardTemplateReward", b =>
                {
                    ...
                    b.HasKey("RewardTemplateId", "RewardKey");

                    b.HasIndex("RewardKey")
                        .HasDatabaseName("IX_RewardTemplateReward_RewardKey");
